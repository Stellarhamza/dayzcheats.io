...
import { OFFICIAL_DAYZ_LINKS } from '../data/links'
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-z-bg text-white">
      ...
      <main className="page-body">
        <section className="page-x pt-12 sm:pt-20">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-white/55">
              Frequently asked questions about DayZ Cheats for DayZ Standalone — Undetected
              status, ESP, silent aim Aimbot, radar hack, official and private server support,
              how to buy, how to load, support, reviews and refunds.
            </p>
            <p className="mt-3 text-sm text-white/45">
              ...
              {' · '}
              <a
                href={OFFICIAL_DAYZ_LINKS[0].href}
                target="_blank"
        ...
        <FaqSection
          id="faq"
          heading="All DayZ Cheats questions"
