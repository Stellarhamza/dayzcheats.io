 ...
 * Every indexed URL maps to a unique crawlable /og/*.jpg under tarkovcheats.io.
 */

export const OG_HOME = '/og/home.jpg'
export const OG_PRODUCT = '/og/tarkov-cheats.jpg'
...
export const TARKOV_OG = OG_PRODUCT
...
export function getOgImageForPath(path?: string): string {
  ...
  if (path === '/tarkov-cheats' || path === '/eft-cheats') return OG_PRODUCT
